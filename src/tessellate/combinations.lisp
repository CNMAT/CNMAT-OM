...
(om::defmethod! get-combi ((dur-space list) (sum integer) (num list) &optional mode)
  :icon 1
...
(om::defmethod! get-combi ((dur-space list) (sum integer) (num integer) &optional mode)
   (get-combi dur-space sum (list num) mode))

(om::defmethod! get-combi ((dur-space list) (sum integer) (num null) &optional mode)
...
(om::defmethod! rotation-canon-query ((voice list) &optional print)
  ...
  (let ((result (canon-query (get-rotations voice))))
