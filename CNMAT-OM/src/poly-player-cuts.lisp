...
(om::defmethod! poly-player-cuts ( (durations-list list) (meter list) (tatum number) (pitches list) (tempo integer) &optional (mode 0))
...
(om::defmethod! poly-player-cuts ( (durations-list prf) (meter list) (tatum list) (pitches list) (tempo integer) &optional (mode 0))
